...
local pressureMessages = {
    "%s... you had one job... please, shoot the murderer already!",
    "%s, why are you just standing there?! The murderer is right in front of you!",
    "Sheriff %s, do something! %s is getting away with murder!",
    "%s, pull the trigger already! %s won’t stop killing!",
    "We believe in you, %s! Just shoot %s before it's too late!",
    "%s... are you going to let %s get away with this?!",
    "Come on, %s! The town is counting on you! Take out %s!",
    "Why are you hesitating, %s? %s is right there with a knife!",
    "Please, %s, for the love of everything, just shoot %s!",
    "%s, if you don’t shoot %s now, we’re all doomed!",
    "Sheriff %s... hello? %s is murdering everyone!",
    "I’m losing faith, %s... %s is standing right there!",
    "%s, if you don’t shoot now, we’re revoking your badge!",
    "Any day now, %s... %s is literally chasing us!",
    "Sheriff %s, this isn’t a staring contest! %s needs to go down!",
    "What are you waiting for, %s?! %s is coming straight at you!",
    "%s... blink twice if you’re scared. Otherwise, shoot %s!",
    "%s, if you let %s win, we’ll never forgive you!",
    "Justice delayed is justice denied, %s! Take out %s!",
    "I swear, %s, if you don’t shoot %s, I’m uninstalling this game.",
    "The gun isn’t just for decoration, %s! Use it on %s!",
    "%s, the whole town is watching... do not embarrass us. Shoot %s!",
    "The fate of the game is in your hands, %s. Don’t let %s win!",
    "%s, stop acting like an NPC and shoot %s already!",
    "%s... your reaction time is slower than my grandma. Shoot %s!",
    "We trusted you, %s! %s is running wild!",
    "Sheriff %s, at this point, I think you’re working with %s...",
    "You had one bullet, %s... make it count! Shoot %s!",
    "All eyes are on you, %s. End %s’s rampage!",
    "%s, If you don’t shoot %s, I’m reporting you for being useless.",
    "I hope you have an excuse ready, %s, because %s is getting away!",
    "Sheriff %s, this is your moment. Don’t fail us against %s!",
    "%s, if you don’t act now, %s will be the reason we all lose!",
    "Oh, come on, %s! Even a bot would have shot %s by now!",
    "%s, we gave you the gun for a reason. Take down %s already!",
    "There is literally ONE murderer, %s. Just shoot %s!",
    "Sheriff %s, I’ll buy you a cookie if you shoot %s right now.",
    "%s... this isn’t a social experiment. Take down %s!",
    "Oh great, %s is giving %s a free win...",
    "%s, do we need to spell it out? S-H-O-O-T %s!",
    "HELP, %s! The murderer is %s, and you're just AFK!",
    "At this point, %s, even a rock would have shot %s faster!",
    "Sheriff %s, what are you aiming at? %s is over there!",
    "We’re losing hope, %s... just shoot %s already!",
    "%s, the game isn’t ‘Run Away From the Murderer,’ it’s ‘Shoot %s’!",
    "Sheriff %s, what’s the hold-up? %s is right there!",
    "%s, if you don’t shoot %s, I’m personally demoting you!",
    "Last chance, %s... don’t let %s win this!",
    "%s, if you let %s win, you owe us all an apology!",
    "Sheriff %s, we will all remember your failure if %s wins...",
    "No pressure, %s, but if you don’t shoot %s, you’re banned from being sheriff.",
    "Sheriff %s, please do your job before %s wipes us all out!",
    "Every second you wait, %s, is another second %s gets closer!",
    "%s, I hope you’re reloading, because %s is coming for you!",
    "This is a betrayal, %s. I thought you’d stop %s!",
    "Please, %s, just one shot! That’s all it takes to stop %s!",
    "We can’t believe what we’re seeing, %s... why aren’t you shooting %s?!",
    "Sheriff %s, you’re making us nervous! Take out %s already!",
    "I think %s is testing our patience. Just shoot %s!",
    "Sheriff %s, are you okay? Because %s isn’t stopping!",
    "%s, do you need permission to shoot %s? Because you have it!",
    "The whole server is begging, %s. Please end %s’s reign of terror!",
    "%s, even my grandma could have shot %s faster than you!",
    "SHOOT %s ALREADY, %s! THIS IS PAINFUL TO WATCH!",
    "Sheriff %s, you’re our last hope... don’t let %s win!",
    "%s, if you let %s win, we’re revoking your sheriff license!",
    "Alright %s, this is getting ridiculous. Shoot %s or pass the gun!",
    "Sheriff %s, you are the ONLY one who can stop %s. What are you waiting for?!",
    "Come on, %s! If you don’t shoot %s, we’re all doomed!",
    "Every missed shot is a gift to %s, %s. Stop giving them chances!",
    "This is not a drill, %s! Take %s down now!",
    "Sheriff %s, you are in the history books for not shooting %s...",
    "We’re all watching you, %s. Don’t let %s get away!",
    "You got this, %s! Just pull the trigger and stop %s!",
    "Sheriff %s, if you clutch this, we will forgive your hesitation against %s!"
}

local chatmessagesbychatgpt = {
    "The murderer is %s and the sheriff is %s!",
    "Breaking news: %s is the murderer, and %s is the sheriff!",
    "Stay alert! %s is on a rampage, but %s is here to stop them!",
    "Chaos vs. Order: %s the murderer, %s the sheriff!",
    "Watch your back! %s has a knife, but %s has a gun!",
    "Who will win? %s, the silent killer, or %s, the town’s protector?",
    "Blood has been spilled... %s is the murderer, and %s must bring justice!",
    "A deadly game begins! %s is the murderer, and %s must stop them!",
    "It's a showdown! %s is the murderer, but %s is watching closely!",
    "Fear the shadows... %s is lurking with a knife, and %s must take them down!",
    "The hunt is on! %s has been identified as the murderer, and %s is in pursuit!",
    "Danger is near... %s is the murderer, but %s is armed and ready!",
    "Trust no one! %s could strike at any moment, but %s won’t let it happen!",
    "Will justice prevail? %s is out for blood, but %s is standing guard!",
    "A killer is among us... %s is the murderer, and %s is our only hope!",
    "A dark day ahead... %s is wielding the knife, while %s holds the law!",
    "The town holds its breath as %s roams with a knife and %s readies their gun!",
    "Death is near... %s has claimed the role of murderer, while %s aims to stop them!",
    "The ultimate face-off: %s vs. %s – who will survive?",
    "A deadly secret... %s is the murderer, but %s is on the case!",
    "The sheriff has one job: stop %s before they strike again!",
    "The night is dangerous... %s has taken lives, but %s won’t let them take more!",
    "Time is running out! %s is the murderer, and %s must act fast!",
    "Who will make the first move? %s is waiting in the shadows, while %s searches for clues!",
    "A fight for survival! %s is the murderer, and %s is on their trail!",
    "The knife glistens in %s’s hands... but %s has a steady aim!",
    "The town is in chaos! %s has turned to murder, and %s must restore order!",
    "Eyes on %s... they are the murderer, but can %s take the shot in time?",
    "The murderer lurks in the dark. %s is ready to strike, but %s is watching!",
    "Whispers fill the air... %s is plotting something, and %s senses danger!",
    "This town ain’t big enough for both %s and %s!",
    "The game of cat and mouse begins... %s is the predator, and %s is the hunter!",
    "The tables can turn at any moment... %s is the murderer, and %s is on edge!",
    "The sheriff is ready! %s is the murderer, and %s won’t back down!",
    "It’s do or die! %s must be stopped, and only %s can do it!",
    "A murderer walks among us... %s is the one, and %s must take action!",
    "Silent but deadly... %s has the knife, and %s has their eyes peeled!",
    "The tension is unbearable... %s has blood on their hands, and %s is closing in!",
    "The murderer is on the loose! %s has the blade, but %s has the badge!",
    "All eyes on %s – the murderer – as %s closes in for the final showdown!",
    "Hold your breath... %s is the murderer, and %s is moments away from confrontation!",
    "Who will strike first? %s grips their knife while %s steadies their aim!",
    "The hunt has begun! %s has taken a life, and %s must put an end to it!",
    "Danger ahead! %s is on a killing spree, and %s is locking onto their target!",
    "One shot, one chance... %s is the murderer, but %s has only one bullet!",
    "The sheriff must choose wisely... %s is the murderer, but where will they strike next?",
    "A killer is loose! %s is wreaking havoc, and only %s can stop them!",
    "The final moments are here... %s is in position, and %s is closing in!",
    "No escape for %s – the murderer – as %s raises their weapon!",
    "The ultimate test of skill: %s vs. %s – who will win?",
    "A crime has been committed! %s is to blame, and %s must deliver justice!",
    "It’s all come down to this... %s has nowhere left to run, and %s is aiming carefully!",
    "A killer’s fate is sealed... %s won’t get away if %s plays their cards right!"
}
...
Converted["_HubDesc"].Text = "teehee i modified it"
...
Converted["_HubName"].Text = "yarhm modified"
...
local function VHCKUS_fake_script() -- Fake Script: StarterGui.YARHM.Murder Mystery 2
	...
	workspace.DescendantAdded:Connect(function(ch)
		...
		if gunDropESP and ch.Name == "GunDrop" then
			...
			if autoGetDroppedGun and getMurderer() ~= game.Players.LocalPlayer then
	...
	table.insert(module, {
		...
		Args = {"Send Sheriff and Murderer names into chat", function(Self)
			...
			for _, textchannel in ipairs(textchannels) do
				...
				local murdName = "--no murderer--"
				local sherName = "--no sheriff--"
				if murd then murdName = murd.Name end
				if sher then sherName = sher.Name end
				local message = string.format(chatmessagesbychatgpt[math.random(1, #chatmessagesbychatgpt)], murdName, sherName)
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Pressure Sheriff", function(Self)
			local textchannels = game:GetService("TextChatService"):WaitForChild("TextChannels"):GetChildren()
			for _, textchannel in ipairs(textchannels) do
				if textchannel.Name == "RBXSystem" then continue end
				local murd = findMurderer()
				...
				if murd then murdName = murd.Name end
				if sher then sherName = sher.Name end
				local message = string.format(pressureMessages[math.random(1, #pressureMessages)], sherName, murdName)
				textchannel:SendAsync(message)
			end
		end,}
	})
	...
	table.insert(module, {
		Type = "ButtonGrid",
		Args = {2, {
			tp_to_Murderer = function()
				if not findMurderer() then
					fu.notification("No murderer")
					return
				end
				game.Players.LocalPlayer.Character:MoveTo(findMurderer().Character.HumanoidRootPart.Position)
			end,
			tp_to_Sheriff = function()
				if not findSheriff() then
					fu.notification("No sheriff")
					return
				end
				game.Players.LocalPlayer.Character:MoveTo(findSheriff().Character.HumanoidRootPart.Position)
			end,
		}}
	})
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Fling person with annoying radio", function(Self)
		    local tabler = {}
			local children = game.Players:GetChildren()
			for i = 1, #children do
			    if children[i].Character and children[i].Character:FindFirstChild("Radio") then
			        if children[i].Character.Radio:FindFirstChildWhichIsA("Sound") then
			            if children[i].Character.Radio:FindFirstChildWhichIsA("Sound").Playing == true then
			                table.insert(tabler, children[i])
			            end
			        end
			    end
			end
			for i = 1, #tabler do
			    if tabler[i] and tabler[i]:IsA("Player") then
			        miniFling(tabler[i])
			    end
			end
		end,}
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Reset Character", function(Self)
